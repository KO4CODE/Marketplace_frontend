...
export default function MarketPlace() {
  const marketPlaceData = [
    { image: marketplace1, name: "Aiboi-meta" },
    { image: marketplace2, name: "Pedram-mohamm..." },
    { image: marketplace3, name: "Eduardo-pena" },
    { image: marketplace4, name: "Daeho-cha" },
    { image: marketplace5, name: "Justine-florentino" },
    { image: marketplace6, name: "Hoang-l-p-solan" },
    { image: marketplace7, name: "Joshua-jay" },
    { image: marketplace8, name: "Joshua-jay" },
  ];
